...
export const MESSAGE_TYPE_ON_PASS_RTC_CONN = 4000;
export const MESSAGE_TYPE_ON_SCREEN_SHARE_REQUEST = 4100;
export const MESSAGE_TYPE_ON_SCREEN_SHARE_RESPONSE = 4101;
